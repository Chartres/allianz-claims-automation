...
(async () => {
  ...
  console.log(`\n✓ Wrote ${cfgFile}`);
  console.log('Next (no accounts/auth needed):');
  console.log('  1. npm install');
  console.log('  2. brew install poppler            # pdftotext (for filing from PDFs)');
  console.log('  3. node bin/launch-chrome.js       → log in (email+password+OTP)');
  console.log('  4. npm run track                   → data/claims.xlsx  (formula-driven Excel)');
  console.log('  • Optional cloud sheet / Gmail intake: see README → Optional Google integration.');
  rl.close();
